...
ITEM_FILE="/item/ModItems.java"
MODEL_PATH="/client/model/CivilNVGModel.java"
RENDERER_PATH="/client/renderer/CivilNVGItemRenderer.java"
NVG_ITEM_FILE="/item/custom/NVGItem.java"

rm -f "/armor/NVGArmorItem.java"
rm -f "/client/renderer/CivilNVGRenderer.java"

mkdir -p "/item/custom"
mkdir -p "/client/renderer"
